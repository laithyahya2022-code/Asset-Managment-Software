...
Two things to know about `itam-demo.html`: it still shows the pre-rename
**"ITAM Enterprise"** name, and its QR/barcode images are decorative patterns
rather than scannable codes (`qrPreview()` draws a deterministic pattern).
